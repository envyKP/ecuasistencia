    ...
    <div class="row justify-content-between">
        ...
        <div>
            <svg class="c-icon c-icon-3xl">
                <use xlink:href="{{ asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-codeigniter') }}"></use>
            </svg>
            <h4>{{ 'Cancelacion Masiva' }} </h4>
        </div>
    </div>
</div>
<div class="row">
                ...
                <form action="{{ route('EaCabCargaInicialController.uploadArchivos') }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 col-md-2">
                            <div class="form-group">
                                <button class="btn btn-success" id="btn-subirArchivo" title="Subir Archivo"
                                    type="submit">
