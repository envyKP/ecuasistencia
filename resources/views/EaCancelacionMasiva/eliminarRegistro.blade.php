<div class="modal fade" id="{{ 'eliminar' . $row }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="{{ route('EaCabCargaInicialController.destroy', [$data->cod_carga]) }}" method="post">
                ...
                <div class="modal-body">
                    <strong>
                        <p>{{ '¿ Desea eliminar el registro de carga corporativa ?' }}
                    </strong></p>
                    <ul>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" type="button" data-dismiss="modal">
                        <svg class="c-icon c-icon-1xl my-1">
                            <use
                                xlink:href="{{ asset('admin/node_modules/@coreui/icons/sprites/free.svg#cil-action-undo') }}">
                            </use>
                        </svg>
                        {{ 'No' }}
                    </button>
