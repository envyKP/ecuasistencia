...
<thead class="thead-light">
    <tr>
        ...
        <th>{{'Nombre de Lotes'}}</th>
        <th>{{'Cliente'}}</th>
        <th>{{'Nombree contrato AMA'}}</th>
...
<tbody>
    ...
    <tr>
        ...
        <td>{{ $registro->nombre_contrato_ama }}</td>
        ...
        <td class="col-sm-1 col-md-1">
            ...
            <div class="row content-center">
                @if( stripos( $registro->estado,'PROCESADO') !== false )
                    ...
                    @include('facMasSegur.detalleCarga', [ 'data' =>  ${'data'.$registro->cod_carga}, 'row' => $row,  'estado_cabecera' => $registro->estado, 'registros_no_cumplen' => session('registros_no_cumplen') ])
                @endif
            ...
            @include('facMasSegur.eliminarRegistro', ['row' => $registro->cod_carga, 'data' => ${'data'.$registro->cod_carga} ])
        </td>
    </tr>
    @endforeach
</tbody>
