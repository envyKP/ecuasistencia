    ...
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
        ...
        <ul class="c-sidebar-nav">
                ...
                @foreach ($Allcampanas as $campana)
                    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
                        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
                            ...
                            </svg>{{ $campana->desc_cliente }}
                        </a>
                        <ul class="c-sidebar-nav-dropdown-items">
                            <li class="c-sidebar-nav-item">
                                <a class="c-sidebar-nav-link"
                                    href="{{ route('EaClienteController.show') . '?cliente=' . $campana->cliente }}">
            ...
            <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
                <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="{{ asset('admin/node_modules/@coreui/icons/sprites/free.svg#cil-search') }} ">
                        </use>
            ...
            <ul class="c-header-nav d-md-down-none">
                @if (strtolower(Auth::user()->rol) == 'admin')
                    <li class="c-header-nav-item px-3"><a class="c-header-nav-link"
                            href="{{ url('/dashboard/admin') }}">{{ 'Menú Administrador' }}</a></li>
                @endif
            </ul>
            <!-- Menu Avatar-->
                ...
                <li class="c-header-nav-item dropdown">
                    <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button"
                        ...
                        @if (!empty(Auth::user()->foto))
                            <div class="c-avatar ml-1"><img class="c-avatar-img"
                                    src="{{ asset('storage') . '/' . Auth::user()->foto }} " alt="x">
                            </div>
                        @endif
