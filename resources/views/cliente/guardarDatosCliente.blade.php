<div class="modal fade" id="guardarDatosCliente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-success" type="button" id="btn-confirmaGuardarDatosCliente">
