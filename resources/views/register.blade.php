      ...
      <div class="row justify-content-center">
        <div class="col-5">
          <div class="card-group">
            <div class="card p-4">
              <div class="card-body">
                <form action="{{ route('UserController.change_pass') }}" method="post">
                 @csrf
                    <div class="text-center">
                        <img class="card-img-top" src="{{ asset('Logos/ecuasistenciaLogin.png') }}"  alt="">
                    </div>
                    <h1 class="text-center">{{'Solicitud de cambio de contraseña'}}</h1>
                    @if(session('errors'))
                    <div class="col">
                        <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input class="form-control" type="text" name="username" placeholder="Username" autocomplete="off" value="{{ isset(Auth::user()->username) ? Auth::user()->username : ''  }}" readonly>
                        @if( session('message'))
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input class="form-control" type="password" name="password_new" placeholder="Nueva contraseña" required>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <button class="btn btn-success px-4" type="submit">{{'Siguiente'}}</button>
                        </div>
                    </div>
                </form>
             </div>
