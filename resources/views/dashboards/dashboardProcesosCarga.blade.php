    ...
    <div class="col-sm-3 col-md-3">
        ...
        <div class="card-body">
            <a href="{{ route('EaGenArchiProveTmkController.index') }}">
                ...
                <small class="text-muted text-uppercase font-weight-bold">{{'Generacion de archivo proveedor TMK'}}</small>
                <div class="progress progress-white progress-xs mt-3">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </a>
    ...
    <div class="col-sm-3 col-md-3">
        ...
        <div class="card-body">
            <a href="{{ route('EaRecepArchiProveTmkController.index') }} ">
                ...
                <small class="text-muted text-uppercase font-weight-bold">{{'Recepcion de archivo proveedor TMK'}}</small>
                <div class="progress progress-white progress-xs mt-3">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </a>
    ...
    <div class="col-sm-3 col-md-3">
        ...
        <div class="card-body">
            <a href="{{ route('EaGenArchiFinanController.index') }}" >
                ...
                <small class="text-muted text-uppercase font-weight-bold">{{'Generacion de archivo cliente corporativo información financiera'}}</small>
                <div class="progress progress-white progress-xs mt-3">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </a>
    ...
    <div class="col-sm-3 col-md-3">
        ...
        <div class="card-body">
            <a href="{{route('EaRecepArchiFinanController.index')}}">
                ...
                <small class="text-muted text-uppercase font-weight-bold">{{'Recepcion de archivo cliente corportativo informacion financiera'}}</small>
                <div class="progress progress-white progress-xs mt-3">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </a>
