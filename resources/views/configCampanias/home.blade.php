        ...
        $(document).ready(function() {
            ...
            $("#clienteCMB").change(function() {
                ...
                if ($("#clienteCMB").val() !== "clienteNull") {
                    ...
                    $.ajax({
                        url: "{{ route('EaProductoController.getProducto') }}?cliente=" + $(this)
                            .val(),
                        method: "GET",
                        success: function(data) {
                            $('#productoID').html(data.htmlProducto);
                            $('#campaniasProductosOpcionesID').html(data.htmlProducto);
                        }
                    });

                    $.ajax({
                        url: "{{ route('EaClienteController.getClienteModel') }}?cliente=" + $(this)
                            .val(),
                        method: "get",
                        success: function(data) {

                            JSON.stringify(data.clienteModel, function(key, value) {
                                $("#clienteLogo").attr("src",
                                    "{{ asset('storage') }}/" + value[0].logotipo);
                            });
                    ...
                    $.ajax({
                        url: "{{ route('EaImpuestosController.getImpuestoHtml') }}?cliente=" + $(
                            this).val(),
                        method: "get",
                        success: function(data) {
            ...
            $("#productoID").change(function() {
                ...
                $.ajax({
                    url: "{{ route('EaSubproductoController.getSubproducto') }}?cliente=" + $(
                        "#clienteCMB").val() + "&contrato_ama=" + $(this).val(),
                    method: "get",
                    success: function(data) {
                ...
                $.ajax({
                    url: "{{ route('EaProductoController.getProductoModel') }}?cliente=" + $(
                        "#clienteCMB").val() + "&contrato_ama=" + $(this).val(),
                    method: "get",
                    success: function(data) {
                        ...
                        JSON.stringify(data.productoModel, function(key, value) {
                            ...
                            $("#desc_productoSubForm").val(value[0]
                                .desc_producto); //para flashed session data

                            //edit - producto blade
                            $("#id_producto").val(value[0].id_producto);
                            $("#cliente").val(value[0].cliente);
                            $("#contrato_amaOLD").val(value[0]
                                .contrato_ama
                            ); //update producto - de todos los subproductos
                            $("#contrato_ama").val(value[0].contrato_ama);
                            $("#subproducto").val(value[0].subproducto);
                            $("#desc_productoOLD").val(value[0]
                                .desc_producto); // para Flashed Session Data
                            ...
                            $("#desc_productoAddSub").val(value[0]
                                .desc_producto); //para flashed session data

                            //Edit Subproducto
                            $("#desc_productoEditSub").val(value[0]
                                .desc_producto); //pata flashed session data
            ...
            $("#subproductoID").change(function() {
                ...
                $.ajax({
                    url: "{{ route('EaSubproductoController.getSubproductoModel') }}?cliente=" + $(
                            "#clienteCMB").val() + "&contrato_ama=" + $("#productoID").val() +
                        "&id_subproducto=" + $(this).val(),
                    method: "get",
                    success: function(data) {
                        JSON.stringify(data.subProductoModel, function(key, value) {
                            ...
                            $("#cod_establecimientoEditForm").val(value[0]
                                .cod_establecimiento);
                            $("#graba_impuestoForm").val(value[0].graba_impuesto);
                            $("#subtotalForm").val(value[0].subtotal);
                            $("#deduccion_impuestoForm").val(parseFloat(value[0]
                                .deduccion_impuesto));

                            if ($("#graba_impuestoForm").val() === 'SI') {
                                $("#valor_porcentajeForm").val(value[0]
                                    .valor_porcentaje);
                            ...
                            $("#cod_establecimientoEdit").val(value[0]
                                .cod_establecimiento);
                            $("#subproductoEdit").val(value[0].subproducto);
                            $("#tipo_subproductoEdit").find('option[value="' + value[0]
                                .tipo_subproducto + '"]').attr("selected",
                                "selected");
                            $("#desc_subproductoEdit").val(value[0].desc_subproducto);

                            $("#valor_porcentajeEdit").val(value[0].valor_porcentaje);
                            $("#deduccion_impuestoEditSub").val(parseFloat(value[0]
                                .deduccion_impuesto));
                            $("#subtotalEditSub").val(value[0].subtotal);
                            $("#valortotalEditSub").val(value[0].valortotal)
                            $("#graba_impuestoEdit").find('option[value="' + value[0]
                                .graba_impuesto + '"]').attr("selected",
                                "selected"); //seteo combo
                            $("#nom_impuestoEdit").find('option[value="' + value[0]
                                .nom_impuesto + '"]').attr("selected", "selected");
                            ...
                            $("#valorOld").val(value[0]
                                .valortotal); // para Flashed Session Data
                            $("#deduccion_impuestoEditSubOld").val(parseFloat(value[0]
                                .deduccion_impuesto)); // para flashed session data
                            $("#subtotalEditSubOld").val(value[0]
                                .subtotal); // para flashed session data
                            $("#graba_impuestoEditOld").val(value[0]
                                .graba_impuesto); // para Flashed session data
                            $("#subproductoOLD").val(value[0]
                                .subproducto
                            ); // para Flashed Session Data subproductoOLD
            ...
            $("#campaniaGenLecID").change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        JSON.stringify(data.subProductoModel, function(key, value) {
                            //infor - la idea de crear un text area crece 
                            // o podria usar una vista a parte que envie los datos de los 
                            //subproductos o solo elimino la parte donde se encuentre el subproducto.
                            $("#id_subprodFormSub").val(value[0].id_subproducto);
                            $("#clienteFormSub").val(value[0].cliente);
                            $("#contrato_amaSubForm").val(value[0].contrato_ama);
                            $("#sub-subproductoForm").val(value[0].subproducto);
            ...
            $("#nom_impuesto").change(function() {
                ...
                $.ajax({
                    url: "{{ route('EaImpuestosController.getImpuestoModel') }}?cliente=" + $(
                        "#clienteCMB").val() + "&nom_impuesto=" + $(this).val(),
                    method: "get",
                    success: function(data) {
                        ...
                        $("#deduccion_impuesto").val(($("#valortotal").val() - $("#subtotal")
                            .val()).toFixed(2));
                    }
                });
            });
            ...
            $("#nom_impuestoEdit").change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#subtotalEditSub").val(($("#valortotalEditSub").val() / impuesto)
                            .toFixed(2));
                        $("#deduccion_impuestoEditSub").val(($("#valortotalEditSub").val() - $(
                            "#subtotalEditSub").val()).toFixed(2));
                    }
                });
            });
            ...
            $("#valortotalEditSub").blur(function() {
                ...
                $("#deduccion_impuestoEditSub").val(($("#valortotalEditSub").val() - $("#subtotalEditSub")
                    .val()).toFixed(2));
            });
...
@section('content')
                ...
                @if (strcmp(session('trxprod'), 'store') === 0)
                    <div class="col-sm-12 col-md-12 my-3">
                        <div class="alert alert-success alert-dismissible fade show " role="alert">
                            ...
                            <div>
                                <strong>{{ 'Nuevo producto: ' }}</strong> {{ session('desc_producto') }}
                ...
                @elseif (strcmp(session('trxprod'), 'update') === 0)
                    <div class="col-sm-12 col-md-12 my-3">
                        <div class="alert alert-info  alert-dismissible fade show " role="alert">
                            <svg class="c-icon c-icon-2xl my-1">
                                <use
                                    xlink:href="{{ asset('admin/node_modules/@coreui/icons/sprites/free.svg#cil-pencil') }}">
                                </use>
                            </svg>
                            ...
                            <div>
                                <strong>{{ 'Contrato AMA: ' }}</strong>{{ session('nom_productoOLD') }}
                                <strong>{{ ' - Actualizado a: ' }}</strong>{{ session('nom_producto') }}
                            </div>
                            <div>
                                <strong>{{ 'Descripción del producto de: ' }}</strong>{{ session('desc_productoOLD') }}
                                <strong>{{ ' - Actualizado a: ' }} </strong>{{ session('desc_producto') }}
                            </div>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                ...
                @elseif (strcmp(session('trxprod'), 'delete') === 0)
                    <div class="col-sm-12 col-md-12 my-3">
                        <div class="alert alert-danger alert-dismissible fade show " role="alert">
                            ...
                            <div>
                                <strong>{{ 'Producto: ' }}</strong> {{ session('desc_producto') }}
                                <strong>{{ ' - Cliente: ' }}</strong>{{ session('cliente') }}
                            </div>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                ...
                @elseif (strcmp(session('trxsubprod'), 'store') === 0)
                    <div class="col-sm-12 col-md-12 my-3">
                        <div class="alert alert-success alert-dismissible fade show " role="alert">
                            ...
                            <div>
                                <strong>{{ 'Nuevo Subproducto: ' }}</strong> {{ session('desc_subproducto') }}
                                <strong>{{ ' - Producto asociado: ' }}</strong>{{ session('productoAddSub') }}
                                <strong>{{ ' - Cliente: ' }}</strong>{{ session('clienteAddSub') }}
                            </div>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                ...
                @elseif (strcmp(session('trxsubprod'), 'update') === 0)
                    <div class="col-sm-12 col-md-12 my-3">
                        <div class="alert alert-warning alert-dismissible fade show " role="alert">
                            ...
                            <div>
                                <strong>{{ 'Valor del Subproducto de: $' }}</strong> {{ session('valorOLD') }}
                                <strong>{{ ' - Actualizado a: $' }}</strong> {{ session('valor') }}
                            </div>
                            <div>
                                <strong>{{ 'Deducción de impuesto de: ' }} </strong>
                                {{ session('deduccion_impuestoOld') }} <strong>{{ ' - Actualizado a: ' }} </strong>
                                {{ session('deduccion_impuesto') }}
                            </div>
                            <div>
                                <strong>{{ 'Subtotal de: ' }} </strong> {{ session('subtotalEditSubOld') }}
                                <strong>{{ ' - Actualizado a: ' }} </strong> {{ session('subtotal') }}
                            </div>
                            <div>
                                <strong>{{ 'Nombre del Subproducto de: ' }}</strong> {{ session('nom_subproductoOLD') }}
                                <strong>{{ ' - Actualizado a: ' }}</strong> {{ session('nom_subproducto') }}
                            </div>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                ...
                @elseif (strcmp(session('trxsubprod'), 'delete') === 0)
                    <div class="col-sm-12 col-md-12 my-3">
                        <div class="alert alert-danger alert-dismissible fade show " role="alert">
                            ...
                            <div>
                                <strong>{{ 'Subproducto: ' }}</strong> {{ session('desc_subproductoForm') }}
                                <strong>{{ '  - Producto asociado: ' }}</strong>{{ session('productoForm') }}
                                <strong>{{ ' - Cliente: ' }}</strong>{{ session('cliente') }}
                            </div>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
            ...
            <div>
                <h4>
                    <svg class="c-icon c-icon-3xl">
                        <use
                            xlink:href="{{ asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-cc-discover') }}">
                        </use>
                    </svg> {{ 'Configuración de Productos Campañas' }}
                </h4>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            @include('configCampanias.campanas', ['Allcampanas' => $Allcampanas])
            @include('configCampanias.producto')
        </div>
        @include('configCampanias.subproducto')
        @include('configCampanias.configOpcionesDebito')
    </div>
@endsection
