                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" id="cliente" name="cliente" value=""
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" maxlength="20" type="text" id="contrato_ama"
                                name="contrato_ama" value="" placeholder="Ingrese Nombre del Producto"
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" id="subproducto" type="text" name="subproducto"
                                placeholder="Nombre Subproducto" oninput="this.value = this.value.toUpperCase();">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" maxlength="100" type="text" id="desc_producto"
                                name="desc_producto" placeholder="{{ 'Ingrese descripción del producto' }}"
                                autocomplete="off" oninput="this.value = this.value.toUpperCase()">
                        </div>
                    </div>
                </div>
