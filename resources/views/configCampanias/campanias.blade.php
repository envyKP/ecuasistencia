        ...
        <div class="card-body">
             <div class="form-group">
                ...
                <div class="modal-footer">
                    <button class="btn btn-success"  type="button"  data-toggle="modal" data-target="#modalAgregaProducto">
                    ...
                    @include('configCampanias.modalAnadirProd')
                    <button class="btn btn-sm btn-outline-danger mr-md-2  my-1" id="" type="button"  data-toggle="modal" data-target="#">
