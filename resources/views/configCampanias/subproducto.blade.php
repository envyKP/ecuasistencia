    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('EaSubproductoController.destroy') }}" id="form-delete-Subpro" method="post">
                        ...
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                                <svg class="c-icon mr-1">
                                    <use
                                        xlink:href=" {{ asset('admin/node_modules/@coreui/icons/sprites/free.svg#cil-home') }}">
                                    </use>
                                </svg>{{ 'Código de Establecimiento' }}
                            </span>
                        </div>
                        <input class="form-control" type="text" id="cod_establecimientoEditForm"
                            name="cod_establecimientoEditForm" value="" placeholder="Código de establecimiento"
                            readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text alert"><svg class="c-icon mr-1">
                                    <use
                                        xlink:href=" {{ asset('admin/node_modules/@coreui/icons/sprites/free.svg#cil-speech') }}">
                                    </use>
                                </svg>{{ 'Descripción' }}
                            </span>
                        </div>
                        <input class="form-control" id="desc_subproductoForm" type="text" name="desc_subproductoForm"
                            placeholder="Descripción Subproducto" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                                <svg class="c-icon mr-1">
                                    <use
                                        xlink:href=" {{ asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-cashapp') }}">
                                    </use>
                                </svg>
                                {{ 'Valor Total' }}
                            </span>
                        </div>
                        <input class="form-control" type="number" step="0.01" id="valortotalform"
                            name="valortotalform" placeholder="{{ '$0.00' }}" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" id="graba_impuestoForm" name="graba_impuestoForm"
                            placeholder="{{ 'Graba impuesto' }}" readonly>
                    </div>
                </div>
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    <svg class="c-icon  mr-1">
                                        <use
                                            xlink:href=" {{ asset('admin/node_modules/@coreui/icons/sprites/free.svg#cil-calculator') }}">
                                        </use>
                                    </svg>
                                    {{ 'ID impuesto' }}
                                </span>
                            </div>
                            <input class="form-control" type="text" name="nom_impuestoFormSub"
                                id="nom_impuestoFormSub" placeholder="ID name del impuesto" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="number" name="valor_porcentajeForm"
                                id="valor_porcentajeForm" placeholder="{{ 'Valor ó Porcentaje del impuesto' }}"
                                readonly>
                            <div class="input-group-append"><span class="input-group-text">
                                    <svg class="c-icon">
                                        <use
                                            xlink:href="{{ asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-slashdot') }}">
                                        </use>
                                    </svg></span>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="number" step="{{ '0.01' }}"
                                name="deduccion_impuestoForm" id="deduccion_impuestoForm"
                                placeholder="{{ 'Valor ó Porcentaje del impuesto' }}" readonly>
                            <div class="input-group-append"><span class="input-group-text">
                                    <svg class="c-icon">
                                        <use
                                            xlink:href="{{ asset('admin/node_modules/@coreui/icons/sprites/brand.svg#cib-slashdot') }}">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="number" name="subtotalForm" id="subtotalForm"
                            placeholder="{{ 'Valor ó Porcentaje del impuesto' }}" readonly>
                        <div class="input-group-append"><span class="input-group-text">
                                <svg class="c-icon">
                                    <use
            ...
            <div class="form-group form-actions row d-flex justify-content-center">
                ...
                <button class="btn btn-sm btn-success mr-md-2 my-1" id="btnAddsubprod" style="visibility:hidden"
                ...
                @include('configCampanias.modalAddSubpro')
