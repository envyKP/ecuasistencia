...
<div class="modal fade" id="dangerModalSubprod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <strong><p>¿ Desea eliminar el Subproducto ?.</strong> </p>
        </div>
        <div class="modal-footer">
            <button class="btn btn-secondary" type="button" id="btnModalEliminarSubproducto" >
