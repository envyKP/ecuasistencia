        ...
        <tbody>
            @foreach ($dataExport as $registro)
                ...
                <tr>
                    ...
                    <td>{{ isset($registro->total_registros_duplicados) ? $registro->total_registros_duplicados : '' }}
                    </td>
                    <td>{{ isset($registro->total_registros_sin_infor) ? $registro->total_registros_sin_infor : '' }}
                    </td>
                    <td>{{ isset($registro->total_registros_disponible_gestion) ? $registro->total_registros_disponible_gestion : '' }}
                    </td>
                    <td>{{ isset($registro->total_registros_gestionados_otras_campanas) ? $registro->total_registros_gestionados_otras_campanas : '' }}
                    </td>
                </tr>
            @endforeach
        </tbody>
