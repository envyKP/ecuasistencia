...
<div class="modal fade" id="elimnarCliente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <strong><p>¿ Desea eliminar el cliente ?.</strong> </p>
            <strong><p style="color:#e55353">{{'Al eliminar el cliente, eliminará todos los impuestos asociados.'}}</p></strong>
        </div>
        <div class="modal-footer">
            <button class="btn btn-secondary" type="button" id="btn-eliminaCliente" >
