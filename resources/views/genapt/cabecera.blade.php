...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <form id="form-GenArchivoProvee" action="{{route('EaGenArchiProveTmkController.exportar_archivo')}}" method="get"  accept-charset="utf-8">
    ...
    <br>
    <div class="col-sm-12 form-group" id="processGenArchiProvee" style="display:none">
