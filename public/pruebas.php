...
//ok se va haciendo mejor por el lado de popup
@section('sidebar')
...
///// json pruebas 
/*
            $("#opcionEntrada").change(function() {
                $.ajax({
                    url: "{{ route('EaSubproductoController.getSelecteOpcion') }}?opciones=" + $(this)
                        .val(),
                    method: "get",
                    success: function(data) {
                        $('#opcionSalida').html(data.htmlSubproducto);
                    }
                });
            });


            $("#opcionSalida").change(function() {
                $.ajax({
                    url: "{{ route('EaSubproductoController.getSelecteOpcion') }}?opciones=" + $(this)
                        .val(),
                    method: "get",
                    success: function(data) {
                        $('#opcionEntrada').html(data.htmlSubproducto);
                    }
                });
            });
*/